...
**Status:** active · **Priority:** product positioning · **Depends on:** latency P0/P1 done  
...
2. Surface latency / safety knobs in TUI (`/tools`, `/info`) so the matrix claims are **user-visible**.  
...
5. [ ] Optional later: TUI `/theme` slash (themes already via keys) — low ROI.  
6. [ ] Optional: README one-liner → FEATURES latency ★.
