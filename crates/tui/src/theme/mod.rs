...
impl fmt::Display for ThemeParseError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(
            f,
            "unknown theme '{}' — falling back to DefaultDark",
            self.name
        )
    }
}
...
impl FromStr for ThemeName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s.to_lowercase().as_str() {
            ...
            "tokyo_night_storm" | "tokyo-night-storm" | "tokyonightstorm" => {
                Ok(Self::TokyoNightStorm)
            }
            "tokyo_night_light" | "tokyo-night-light" | "tokyonightlight" => {
                Ok(Self::TokyoNightLight)
            }
            ...
            "material_palenight" | "material-palenight" | "palenight" => {
                Ok(Self::MaterialPalenight)
            }
...
fn palette_default_dark() -> ThemePalette {
    ...
    ThemePalette {
        ...
        dim: TEXT_MUTED,
        highlight: PRIMARY,
        status_bar_bg: STEP2_PANEL,
        status_bar_fg: TEXT_MUTED,
        input_bg: STEP2_PANEL,
        input_fg: TEXT,
...
fn palette_monokai() -> ThemePalette {
    ThemePalette {
        ...
        status_bar_bg: Color::Rgb(35, 36, 31),
        status_bar_fg: Color::Rgb(117, 113, 94),
        input_bg: Color::Rgb(35, 36, 31),
        input_fg: Color::Rgb(248, 248, 242),
        sidebar_bg: Color::Rgb(35, 36, 31),
        dialog_bg: Color::Rgb(46, 48, 40),
        dialog_border: Color::Rgb(166, 226, 46),
        scrollbar: Color::Rgb(73, 72, 62),
...
fn palette_solarized_dark() -> ThemePalette {
    ThemePalette {
        ...
        status_bar_bg: Color::Rgb(0, 37, 46),
        status_bar_fg: Color::Rgb(88, 110, 117),
        input_bg: Color::Rgb(0, 37, 46),
        input_fg: Color::Rgb(131, 148, 150),
        sidebar_bg: Color::Rgb(0, 37, 46),
        dialog_bg: Color::Rgb(7, 54, 66),
        dialog_border: Color::Rgb(38, 139, 210),
        scrollbar: Color::Rgb(7, 54, 66),
...
fn palette_solarized_light() -> ThemePalette {
    ThemePalette {
        ...
        sidebar_bg: Color::Rgb(238, 232, 213),
        dialog_bg: Color::Rgb(245, 242, 230),
        dialog_border: Color::Rgb(38, 139, 210),
        scrollbar: Color::Rgb(238, 232, 213),
        diff_add: Color::Rgb(133, 153, 0),
        diff_remove: Color::Rgb(220, 50, 47),
        diff_hunk: Color::Rgb(38, 139, 210),
    }
...
fn palette_nord() -> ThemePalette {
    ThemePalette {
        ...
        tool_msg: Color::Rgb(208, 135, 112),
        ...
        sidebar_bg: Color::Rgb(40, 44, 52),
        dialog_bg: Color::Rgb(54, 60, 72),
        dialog_border: Color::Rgb(136, 192, 208),
        scrollbar: Color::Rgb(59, 66, 82),
...
fn palette_dracula() -> ThemePalette {
    ThemePalette {
        ...
        tool_msg: Color::Rgb(255, 184, 108),
        ...
        status_bar_bg: Color::Rgb(34, 36, 46),
        status_bar_fg: Color::Rgb(98, 114, 164),
        input_bg: Color::Rgb(34, 36, 46),
        input_fg: Color::Rgb(248, 248, 242),
        sidebar_bg: Color::Rgb(34, 36, 46),
        dialog_bg: Color::Rgb(50, 52, 66),
...
fn palette_gruvbox() -> ThemePalette {
    ThemePalette {
        ...
        status_bar_bg: Color::Rgb(34, 34, 34),
        status_bar_fg: Color::Rgb(102, 92, 84),
        input_bg: Color::Rgb(34, 34, 34),
        input_fg: Color::Rgb(235, 219, 178),
        sidebar_bg: Color::Rgb(34, 34, 34),
        dialog_bg: Color::Rgb(50, 48, 46),
        dialog_border: Color::Rgb(250, 189, 47),
        scrollbar: Color::Rgb(60, 56, 54),
...
fn palette_one_dark() -> ThemePalette {
    ThemePalette {
        ...
        status_bar_bg: Color::Rgb(34, 38, 44),
        status_bar_fg: Color::Rgb(92, 99, 112),
        input_bg: Color::Rgb(34, 38, 44),
        input_fg: Color::Rgb(171, 178, 191),
        sidebar_bg: Color::Rgb(34, 38, 44),
        dialog_bg: Color::Rgb(50, 54, 62),
        dialog_border: Color::Rgb(97, 175, 239),
        scrollbar: Color::Rgb(56, 60, 68),
        diff_add: Color::Rgb(152, 195, 121),
        diff_remove: Color::Rgb(224, 108, 117),
...
fn palette_catppuccin_mocha() -> ThemePalette {
    ThemePalette {
        ...
        tool_msg: Color::Rgb(250, 179, 135),
...
fn palette_tokyo_night() -> ThemePalette {
    ThemePalette {
        ...
        tool_msg: Color::Rgb(255, 158, 100),
        ...
        status_bar_bg: Color::Rgb(22, 23, 32),
        status_bar_fg: Color::Rgb(86, 95, 137),
        input_bg: Color::Rgb(22, 23, 32),
        input_fg: Color::Rgb(169, 177, 214),
        sidebar_bg: Color::Rgb(22, 23, 32),
        dialog_bg: Color::Rgb(33, 35, 48),
        dialog_border: Color::Rgb(122, 162, 247),
        scrollbar: Color::Rgb(41, 46, 66),
...
fn palette_tokyo_night_storm() -> ThemePalette {
    ThemePalette {
        ...
        status_bar_bg: Color::Rgb(30, 34, 50),
        status_bar_fg: Color::Rgb(86, 95, 137),
        input_bg: Color::Rgb(30, 34, 50),
        input_fg: Color::Rgb(192, 202, 245),
        sidebar_bg: Color::Rgb(30, 34, 50),
        dialog_bg: Color::Rgb(44, 48, 68),
        dialog_border: Color::Rgb(125, 207, 255),
        scrollbar: Color::Rgb(52, 57, 78),
        diff_add: Color::Rgb(158, 206, 106),
        diff_remove: Color::Rgb(247, 118, 142),
...
fn palette_tokyo_night_light() -> ThemePalette {
    ThemePalette {
        bg: Color::Rgb(213, 219, 242),
        fg: Color::Rgb(52, 59, 88),
        border: Color::Rgb(192, 200, 230),
        border_focused: Color::Rgb(52, 84, 209),
        accent: Color::Rgb(52, 84, 209),
        user_msg: Color::Rgb(52, 84, 209),
        assistant_msg: Color::Rgb(72, 128, 38),
        system_msg: Color::Rgb(140, 94, 28),
        tool_msg: Color::Rgb(200, 80, 12),
        thinking: Color::Rgb(120, 62, 200),
        error: Color::Rgb(200, 42, 64),
        warning: Color::Rgb(140, 94, 28),
        success: Color::Rgb(72, 128, 38),
        info: Color::Rgb(52, 84, 209),
        dim: Color::Rgb(140, 148, 180),
        highlight: Color::Rgb(200, 80, 12),
        status_bar_bg: Color::Rgb(200, 206, 232),
        status_bar_fg: Color::Rgb(140, 148, 180),
        input_bg: Color::Rgb(200, 206, 232),
        input_fg: Color::Rgb(52, 59, 88),
        sidebar_bg: Color::Rgb(200, 206, 232),
        dialog_bg: Color::Rgb(224, 228, 248),
        dialog_border: Color::Rgb(52, 84, 209),
        scrollbar: Color::Rgb(192, 200, 230),
        diff_add: Color::Rgb(72, 128, 38),
        diff_remove: Color::Rgb(200, 42, 64),
...
fn palette_kanagawa() -> ThemePalette {
    ThemePalette {
        ...
        border: Color::Rgb(54, 54, 62),
        border_focused: Color::Rgb(126, 156, 216),
        accent: Color::Rgb(126, 156, 216),
        user_msg: Color::Rgb(126, 156, 216),
        assistant_msg: Color::Rgb(152, 187, 108),
        system_msg: Color::Rgb(230, 200, 110),
        tool_msg: Color::Rgb(255, 160, 100),
        thinking: Color::Rgb(149, 127, 184),
        error: Color::Rgb(230, 90, 90),
        warning: Color::Rgb(230, 200, 110),
        success: Color::Rgb(152, 187, 108),
        info: Color::Rgb(126, 156, 216),
        dim: Color::Rgb(84, 84, 96),
        highlight: Color::Rgb(255, 160, 100),
        status_bar_bg: Color::Rgb(26, 26, 34),
        status_bar_fg: Color::Rgb(84, 84, 96),
        input_bg: Color::Rgb(26, 26, 34),
        input_fg: Color::Rgb(220, 215, 186),
        sidebar_bg: Color::Rgb(26, 26, 34),
        dialog_bg: Color::Rgb(40, 40, 50),
        dialog_border: Color::Rgb(126, 156, 216),
        scrollbar: Color::Rgb(54, 54, 62),
        diff_add: Color::Rgb(152, 187, 108),
        diff_remove: Color::Rgb(230, 90, 90),
...
fn palette_everforest() -> ThemePalette {
    ThemePalette {
        ...
        border: Color::Rgb(61, 71, 78),
        border_focused: Color::Rgb(131, 192, 146),
        accent: Color::Rgb(131, 192, 146),
        user_msg: Color::Rgb(131, 192, 146),
        assistant_msg: Color::Rgb(167, 192, 128),
        system_msg: Color::Rgb(219, 188, 127),
        tool_msg: Color::Rgb(230, 152, 117),
        thinking: Color::Rgb(214, 153, 182),
        error: Color::Rgb(230, 126, 128),
        warning: Color::Rgb(219, 188, 127),
        success: Color::Rgb(167, 192, 128),
        info: Color::Rgb(131, 192, 146),
        dim: Color::Rgb(89, 102, 111),
        highlight: Color::Rgb(230, 152, 117),
        status_bar_bg: Color::Rgb(38, 45, 50),
        status_bar_fg: Color::Rgb(89, 102, 111),
        input_bg: Color::Rgb(38, 45, 50),
        input_fg: Color::Rgb(211, 198, 170),
        sidebar_bg: Color::Rgb(38, 45, 50),
        dialog_bg: Color::Rgb(53, 62, 68),
        dialog_border: Color::Rgb(131, 192, 146),
        scrollbar: Color::Rgb(61, 71, 78),
        diff_add: Color::Rgb(167, 192, 128),
        diff_remove: Color::Rgb(230, 126, 128),
...
fn palette_rose_pine() -> ThemePalette {
    ThemePalette {
        ...
        user_msg: Color::Rgb(156, 207, 216),
        assistant_msg: Color::Rgb(144, 190, 126),
        system_msg: Color::Rgb(246, 193, 119),
        tool_msg: Color::Rgb(235, 188, 186),
        thinking: Color::Rgb(196, 167, 231),
        error: Color::Rgb(235, 111, 146),
        warning: Color::Rgb(246, 193, 119),
        success: Color::Rgb(144, 190, 126),
        info: Color::Rgb(156, 207, 216),
        dim: Color::Rgb(110, 106, 134),
        highlight: Color::Rgb(235, 188, 186),
        status_bar_bg: Color::Rgb(20, 18, 30),
        status_bar_fg: Color::Rgb(110, 106, 134),
        input_bg: Color::Rgb(20, 18, 30),
        input_fg: Color::Rgb(224, 222, 244),
        sidebar_bg: Color::Rgb(20, 18, 30),
        dialog_bg: Color::Rgb(33, 30, 46),
        dialog_border: Color::Rgb(196, 167, 231),
        scrollbar: Color::Rgb(38, 35, 58),
        diff_add: Color::Rgb(144, 190, 126),
        diff_remove: Color::Rgb(235, 111, 146),
...
fn palette_rose_pine_moon() -> ThemePalette {
    ThemePalette {
        ...
        dim: Color::Rgb(110, 106, 134),
        highlight: Color::Rgb(235, 188, 186),
        status_bar_bg: Color::Rgb(28, 26, 44),
        status_bar_fg: Color::Rgb(110, 106, 134),
        input_bg: Color::Rgb(28, 26, 44),
        input_fg: Color::Rgb(224, 222, 244),
        sidebar_bg: Color::Rgb(28, 26, 44),
        dialog_bg: Color::Rgb(44, 42, 64),
        dialog_border: Color::Rgb(196, 167, 231),
        scrollbar: Color::Rgb(48, 45, 65),
        diff_add: Color::Rgb(144, 190, 126),
        diff_remove: Color::Rgb(235, 111, 146),
        diff_hunk: Color::Rgb(196, 167, 231),
    }
...
fn palette_rose_pine_dawn() -> ThemePalette {
    ThemePalette {
        ...
        border: Color::Rgb(240, 222, 222),
        border_focused: Color::Rgb(144, 122, 169),
        accent: Color::Rgb(144, 122, 169),
        user_msg: Color::Rgb(40, 105, 131),
        assistant_msg: Color::Rgb(40, 120, 68),
        system_msg: Color::Rgb(190, 100, 40),
        tool_msg: Color::Rgb(180, 99, 122),
        thinking: Color::Rgb(144, 122, 169),
        error: Color::Rgb(180, 99, 122),
        warning: Color::Rgb(190, 100, 40),
        success: Color::Rgb(40, 120, 68),
        info: Color::Rgb(40, 105, 131),
        dim: Color::Rgb(155, 147, 175),
        highlight: Color::Rgb(210, 130, 80),
        status_bar_bg: Color::Rgb(242, 236, 230),
        status_bar_fg: Color::Rgb(155, 147, 175),
        input_bg: Color::Rgb(242, 236, 230),
        input_fg: Color::Rgb(87, 82, 121),
        sidebar_bg: Color::Rgb(242, 236, 230),
        dialog_bg: Color::Rgb(248, 245, 240),
        dialog_border: Color::Rgb(144, 122, 169),
        scrollbar: Color::Rgb(240, 222, 222),
        diff_add: Color::Rgb(40, 120, 68),
        diff_remove: Color::Rgb(180, 99, 122),
...
fn palette_ayu_dark() -> ThemePalette {
    ThemePalette {
        ...
        fg: Color::Rgb(191, 189, 171),
        border: Color::Rgb(30, 35, 40),
        border_focused: Color::Rgb(255, 180, 84),
        accent: Color::Rgb(255, 180, 84),
        user_msg: Color::Rgb(89, 193, 255),
        assistant_msg: Color::Rgb(168, 210, 120),
        system_msg: Color::Rgb(255, 180, 84),
        tool_msg: Color::Rgb(255, 142, 80),
        thinking: Color::Rgb(210, 168, 255),
        error: Color::Rgb(255, 102, 102),
        warning: Color::Rgb(255, 180, 84),
        success: Color::Rgb(168, 210, 120),
        info: Color::Rgb(89, 193, 255),
        dim: Color::Rgb(96, 102, 106),
        highlight: Color::Rgb(255, 180, 84),
        status_bar_bg: Color::Rgb(12, 16, 20),
        status_bar_fg: Color::Rgb(96, 102, 106),
        input_bg: Color::Rgb(12, 16, 20),
        input_fg: Color::Rgb(191, 189, 171),
        sidebar_bg: Color::Rgb(12, 16, 20),
        dialog_bg: Color::Rgb(22, 28, 33),
        dialog_border: Color::Rgb(255, 180, 84),
        scrollbar: Color::Rgb(30, 35, 40),
        diff_add: Color::Rgb(168, 210, 120),
        diff_remove: Color::Rgb(255, 102, 102),
...
fn palette_ayu_mirage() -> ThemePalette {
    ThemePalette {
        ...
        fg: Color::Rgb(204, 195, 163),
        border: Color::Rgb(44, 50, 58),
        border_focused: Color::Rgb(255, 204, 102),
        accent: Color::Rgb(255, 204, 102),
        user_msg: Color::Rgb(115, 218, 255),
        assistant_msg: Color::Rgb(186, 230, 126),
        system_msg: Color::Rgb(255, 204, 102),
        tool_msg: Color::Rgb(255, 160, 90),
        thinking: Color::Rgb(223, 180, 255),
        error: Color::Rgb(255, 116, 116),
        warning: Color::Rgb(255, 204, 102),
        success: Color::Rgb(186, 230, 126),
        info: Color::Rgb(115, 218, 255),
        dim: Color::Rgb(92, 99, 108),
        highlight: Color::Rgb(255, 204, 102),
        status_bar_bg: Color::Rgb(18, 22, 28),
        status_bar_fg: Color::Rgb(92, 99, 108),
        input_bg: Color::Rgb(18, 22, 28),
        input_fg: Color::Rgb(204, 195, 163),
        sidebar_bg: Color::Rgb(18, 22, 28),
        dialog_bg: Color::Rgb(30, 34, 42),
        dialog_border: Color::Rgb(255, 204, 102),
        scrollbar: Color::Rgb(44, 50, 58),
        diff_add: Color::Rgb(186, 230, 126),
        diff_remove: Color::Rgb(255, 116, 116),
...
fn palette_ayu_light() -> ThemePalette {
    ThemePalette {
        ...
        border: Color::Rgb(210, 215, 218),
        border_focused: Color::Rgb(255, 138, 48),
        accent: Color::Rgb(255, 138, 48),
        user_msg: Color::Rgb(3, 155, 229),
        assistant_msg: Color::Rgb(104, 179, 56),
        system_msg: Color::Rgb(255, 138, 48),
        tool_msg: Color::Rgb(240, 113, 42),
        thinking: Color::Rgb(160, 108, 213),
        error: Color::Rgb(252, 57, 57),
        warning: Color::Rgb(255, 138, 48),
        success: Color::Rgb(104, 179, 56),
        info: Color::Rgb(3, 155, 229),
        dim: Color::Rgb(140, 144, 148),
        highlight: Color::Rgb(240, 113, 42),
        status_bar_bg: Color::Rgb(238, 238, 238),
        status_bar_fg: Color::Rgb(140, 144, 148),
        input_bg: Color::Rgb(238, 238, 238),
        input_fg: Color::Rgb(92, 97, 102),
        sidebar_bg: Color::Rgb(238, 238, 238),
        dialog_bg: Color::Rgb(245, 245, 245),
        dialog_border: Color::Rgb(255, 138, 48),
        scrollbar: Color::Rgb(210, 215, 218),
        diff_add: Color::Rgb(104, 179, 56),
        diff_remove: Color::Rgb(252, 57, 57),
...
fn palette_github_dark() -> ThemePalette {
    ThemePalette {
        ...
        assistant_msg: Color::Rgb(63, 185, 80),
        system_msg: Color::Rgb(210, 153, 34),
        tool_msg: Color::Rgb(242, 135, 40),
        thinking: Color::Rgb(188, 140, 255),
        error: Color::Rgb(248, 81, 73),
        warning: Color::Rgb(210, 153, 34),
        success: Color::Rgb(63, 185, 80),
        info: Color::Rgb(88, 166, 255),
        dim: Color::Rgb(125, 133, 144),
        highlight: Color::Rgb(242, 135, 40),
        status_bar_bg: Color::Rgb(1, 4, 9),
        status_bar_fg: Color::Rgb(125, 133, 144),
        input_bg: Color::Rgb(1, 4, 9),
        input_fg: Color::Rgb(201, 209, 217),
        sidebar_bg: Color::Rgb(1, 4, 9),
        dialog_bg: Color::Rgb(22, 27, 34),
        dialog_border: Color::Rgb(88, 166, 255),
        scrollbar: Color::Rgb(33, 38, 45),
...
fn palette_github_light() -> ThemePalette {
    ThemePalette {
        ...
        user_msg: Color::Rgb(9, 105, 218),
        assistant_msg: Color::Rgb(26, 127, 55),
        system_msg: Color::Rgb(154, 103, 0),
        tool_msg: Color::Rgb(188, 76, 0),
        thinking: Color::Rgb(130, 80, 223),
        ...
        highlight: Color::Rgb(188, 76, 0),
        status_bar_bg: Color::Rgb(246, 248, 250),
        status_bar_fg: Color::Rgb(101, 109, 118),
        input_bg: Color::Rgb(246, 248, 250),
        input_fg: Color::Rgb(36, 41, 47),
        sidebar_bg: Color::Rgb(246, 248, 250),
        dialog_bg: Color::Rgb(250, 250, 252),
        dialog_border: Color::Rgb(9, 105, 218),
        scrollbar: Color::Rgb(208, 215, 222),
        diff_add: Color::Rgb(26, 127, 55),
        diff_remove: Color::Rgb(207, 34, 46),
...
fn palette_vscode_dark() -> ThemePalette {
    ThemePalette {
        ...
        user_msg: Color::Rgb(86, 156, 214),
        assistant_msg: Color::Rgb(96, 139, 78),
        system_msg: Color::Rgb(220, 220, 170),
        tool_msg: Color::Rgb(206, 145, 120),
        thinking: Color::Rgb(197, 134, 192),
        error: Color::Rgb(244, 71, 71),
        warning: Color::Rgb(220, 220, 170),
        success: Color::Rgb(96, 139, 78),
        info: Color::Rgb(86, 156, 214),
        dim: Color::Rgb(90, 90, 90),
        highlight: Color::Rgb(206, 145, 120),
        status_bar_bg: Color::Rgb(0, 122, 204),
        status_bar_fg: Color::Rgb(255, 255, 255),
        input_bg: Color::Rgb(37, 37, 38),
        input_fg: Color::Rgb(212, 212, 212),
        sidebar_bg: Color::Rgb(37, 37, 38),
        dialog_bg: Color::Rgb(45, 45, 45),
        dialog_border: Color::Rgb(86, 156, 214),
        scrollbar: Color::Rgb(66, 66, 66),
        diff_add: Color::Rgb(96, 139, 78),
        diff_remove: Color::Rgb(244, 71, 71),
...
fn palette_vscode_light() -> ThemePalette {
    ThemePalette {
        ...
        border_focused: Color::Rgb(0, 92, 230),
        accent: Color::Rgb(0, 92, 230),
        user_msg: Color::Rgb(0, 92, 230),
        assistant_msg: Color::Rgb(0, 128, 0),
        system_msg: Color::Rgb(180, 130, 0),
        tool_msg: Color::Rgb(200, 100, 40),
        thinking: Color::Rgb(128, 0, 200),
        error: Color::Rgb(220, 40, 40),
        warning: Color::Rgb(180, 130, 0),
        success: Color::Rgb(0, 128, 0),
        info: Color::Rgb(0, 92, 230),
        dim: Color::Rgb(160, 160, 160),
        highlight: Color::Rgb(200, 100, 40),
        status_bar_bg: Color::Rgb(0, 120, 212),
        status_bar_fg: Color::Rgb(255, 255, 255),
        input_bg: Color::Rgb(250, 250, 250),
        input_fg: Color::Rgb(30, 30, 30),
        sidebar_bg: Color::Rgb(250, 250, 250),
        dialog_bg: Color::Rgb(248, 248, 248),
        dialog_border: Color::Rgb(0, 92, 230),
        scrollbar: Color::Rgb(200, 200, 200),
        diff_add: Color::Rgb(0, 128, 0),
        diff_remove: Color::Rgb(220, 40, 40),
...
fn palette_zenburn() -> ThemePalette {
    ThemePalette {
        ...
        border_focused: Color::Rgb(140, 180, 140),
        accent: Color::Rgb(140, 180, 140),
        user_msg: Color::Rgb(140, 208, 211),
        assistant_msg: Color::Rgb(140, 180, 140),
        system_msg: Color::Rgb(224, 206, 132),
        tool_msg: Color::Rgb(220, 163, 163),
        thinking: Color::Rgb(204, 147, 204),
        error: Color::Rgb(220, 120, 120),
        warning: Color::Rgb(224, 206, 132),
        success: Color::Rgb(140, 180, 140),
        info: Color::Rgb(140, 208, 211),
        dim: Color::Rgb(101, 101, 101),
        highlight: Color::Rgb(220, 163, 163),
        status_bar_bg: Color::Rgb(54, 54, 54),
        status_bar_fg: Color::Rgb(101, 101, 101),
        input_bg: Color::Rgb(54, 54, 54),
        input_fg: Color::Rgb(220, 220, 204),
        sidebar_bg: Color::Rgb(54, 54, 54),
        dialog_bg: Color::Rgb(70, 70, 70),
        dialog_border: Color::Rgb(140, 180, 140),
        scrollbar: Color::Rgb(80, 80, 80),
        diff_add: Color::Rgb(140, 180, 140),
        diff_remove: Color::Rgb(220, 120, 120),
...
fn palette_oceanic_next() -> ThemePalette {
    ThemePalette {
        ...
        fg: Color::Rgb(205, 211, 215),
        border: Color::Rgb(40, 62, 74),
        border_focused: Color::Rgb(102, 153, 204),
        accent: Color::Rgb(102, 153, 204),
        user_msg: Color::Rgb(102, 153, 204),
        assistant_msg: Color::Rgb(153, 199, 148),
        system_msg: Color::Rgb(250, 200, 99),
        tool_msg: Color::Rgb(236, 95, 103),
        thinking: Color::Rgb(197, 148, 197),
        error: Color::Rgb(236, 95, 103),
        warning: Color::Rgb(250, 200, 99),
        success: Color::Rgb(153, 199, 148),
        info: Color::Rgb(102, 153, 204),
        dim: Color::Rgb(84, 114, 131),
        highlight: Color::Rgb(247, 140, 108),
        status_bar_bg: Color::Rgb(20, 34, 42),
        status_bar_fg: Color::Rgb(84, 114, 131),
        input_bg: Color::Rgb(20, 34, 42),
        input_fg: Color::Rgb(205, 211, 215),
        sidebar_bg: Color::Rgb(20, 34, 42),
        dialog_bg: Color::Rgb(34, 52, 63),
        dialog_border: Color::Rgb(102, 153, 204),
        scrollbar: Color::Rgb(40, 62, 74),
        diff_add: Color::Rgb(153, 199, 148),
        diff_remove: Color::Rgb(236, 95, 103),
...
fn palette_material_palenight() -> ThemePalette {
    ThemePalette {
        ...
        assistant_msg: Color::Rgb(195, 232, 141),
        system_msg: Color::Rgb(255, 203, 107),
        tool_msg: Color::Rgb(247, 140, 108),
        thinking: Color::Rgb(199, 146, 234),
        error: Color::Rgb(255, 83, 112),
        warning: Color::Rgb(255, 203, 107),
        success: Color::Rgb(195, 232, 141),
        info: Color::Rgb(130, 170, 255),
        dim: Color::Rgb(103, 110, 149),
        highlight: Color::Rgb(247, 140, 108),
        status_bar_bg: Color::Rgb(33, 37, 52),
        status_bar_fg: Color::Rgb(103, 110, 149),
        input_bg: Color::Rgb(33, 37, 52),
        input_fg: Color::Rgb(166, 172, 205),
        sidebar_bg: Color::Rgb(33, 37, 52),
        dialog_bg: Color::Rgb(50, 54, 72),
        dialog_border: Color::Rgb(199, 146, 234),
        scrollbar: Color::Rgb(55, 60, 78),
