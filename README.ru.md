...
| Первый кадр (harness, in-proc) | **131 ms** (наследование консоли) | **12 ms** (PTY 80×24) |
| Перерисовки в простое (harness, 3 с) | **0.6 /s** | **0.3 /s** |

TUI рисует только при изменениях. В этом прогоне Windows 3 с простоя
harness — **0.6 перерисовок/с** (Linux 2026-09-02 было 0.3/s); целевой
