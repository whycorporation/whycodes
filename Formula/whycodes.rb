...
# Generated by scripts/update_homebrew_formula.sh for v0.2.0.
...
class Whycodes < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/whycorporation/whycodes/releases/download/v0.2.0/whycodes-aarch64-apple-darwin.tar.gz"
      sha256 "1ffcdf76363f60f87e2402d880e68e97135adfa4fb85f4feff76e86dfa535be5"
    end

    on_intel do
      url "https://github.com/whycorporation/whycodes/releases/download/v0.2.0/whycodes-x86_64-apple-darwin.tar.gz"
      sha256 "09f306a63f64b8f89726098219d423a782479d74a19b0889a1fdda19fac8ad05"
    end
  end

  on_linux do
    on_intel do
      url "https://github.com/whycorporation/whycodes/releases/download/v0.2.0/whycodes-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "df37f743919f3bcd2114170be68c9bde2e531b3450ef804b1b4b7b3c0199d211"
    end
  end
